package com.lucas.service.util;
...
public class ZipUtil {
    ...
    private static String filePath = "D:/compress/put.txt";
    private static String outPath = "D:/compress/put.zip";
    private static String unZipPath = "D:/compress/";
    /**
     * 是否保留原来的目录结构
     * true:  保留目录结构;
